...
def app():
    ...
    while True:
        ...
        match(int(opcion)):
            ...
            case 16:
                imprimir_promedio_puntos_excluyendo_menor(
                    json_copy['jugadores'])
            case 17:
            ...
            case 20:
                imprimir_jugadores_supera_valor_ordenados(
                    json_copy['jugadores'])
            case 21:
                lista_estadisticas = [
            ...
            case 22:
                imprimir_cantidad_jugadores_por_posicion(
                    json_copy['jugadores'])
            case 23:
            ...
            case 25:
                imprimir_mejor_jugador_total_estadisticas(
                    json_copy['jugadores'])
            case 0:
                break
            case _:
